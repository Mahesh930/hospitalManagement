...
public class RolePermissionMapping {
    private static final Map<RoleType, Set<PermissionType>> map = Map.of(
            SUPER_ADMIN, Set.of(PATIENT_READ, PATIENT_WRITE, APPOINTMENT_READ, APPOINTMENT_WRITE, APPOINTMENT_DELETE,
                    OPD_READ, OPD_WRITE, BILLING_READ, BILLING_WRITE, MASTER_DATA_MANAGE, USER_MANAGE, REPORT_VIEW, NURSE_READ, NURSE_WRITE, BED_MANAGE),
            ...
            DOCTOR, Set.of(APPOINTMENT_DELETE, APPOINTMENT_WRITE, APPOINTMENT_READ, PATIENT_READ, OPD_READ, OPD_WRITE, NURSE_READ),
            ...
            NURSE, Set.of(PATIENT_READ, OPD_READ, OPD_WRITE, APPOINTMENT_READ, NURSE_READ, NURSE_WRITE, BED_MANAGE),
